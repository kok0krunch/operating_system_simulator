...
def lfu_menu(screen):
    """
    Main GUI function for LFU Page Replacement.
    ...
    def find_lfu_index(frames, frequency, cap):
    ...
    def run_lfu_simulation(seq, cap):
        ...
        for page in seq:
            ...
            if page in frames:
                ...
                # Case 2: Memory is full. Run the LFU internal frequency inspection.
                else:
                    replaced_index = find_lfu_index(frames, frequency, cap)
                    frames[replaced_index] = page
    ...
    while running:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        try:
                            ...
                            if not page_sequence:
                                ...
                                error_message = ""
                                run_lfu_simulation(page_sequence, capacity)
                                state = 2
                        except ValueError:
        ...
        title_surface = font_title.render("VIRTUAL MEMORY: Least Frequently Used (LFU) Page Replacement", True, BLACK)
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Virtual Memory LFU Page Replacement")
    lfu_menu(main_screen)