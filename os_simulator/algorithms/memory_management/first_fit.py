...
def mvt_menu(screen):
    ...
    while running:
        ...
        title_surface = font_title.render("MEMORY MANAGEMENT: Firs-Fit Algorithm (MVT)", True, BLACK)
...
def mft_menu(screen):
    ...
    while running:
        ...
        # 1. Top Left Header Panel
        title_surface = font_title.render("MEMORY MANAGEMENT: First-Fit Algorithm(MFT)", True, BLACK)
        screen.blit(title_surface, (20, 10))
