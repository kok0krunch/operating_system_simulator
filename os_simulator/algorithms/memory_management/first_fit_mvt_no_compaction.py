...
def ff_no_compaction_logic(screen):
    ...
    pygame.display.set_caption("First Fit (MVT - Without Compaction)")
    ...
    while running:
        ...
        title_surface = font_title.render("MEMORY MANAGEMENT: First Fit (MVT - Without Compaction)", True, BLACK if background else NEON_GREEN)
